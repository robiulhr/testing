      ...
      <div className="Content__container">
        ...
        <div className="services">
          <div className="pharmacy section active">
            ...
            <p>
              <span>Pharmacy</span>
              Apoquel is an oral tablet that works differently than other allergy medication, it goes straight to the source to help relieve itch and inflammations at its core-addressing the underlying cause of irritation
            </p>
            <button>
              <a>explore</a>
            </button>
          ...
          <div className="haircut section">
            ...
            <p>
              ...
              Regular grooming is essential to your pet's health as it helps prevent skin issues such as malting
            </p>
            <button>
              <a>explore</a>
            </button>
          ...
          <div className="cloths section">
            ...
            <p>
              <span>cloths</span>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos provident magnam dolor! Sapiente error saepe commodi totam aperiam architecto sit esse reiciendis fuga! Sunt, animi!
            </p>
            <button>
              <a>explore</a>
            </button>
